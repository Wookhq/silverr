...
class FilesFunctions {
	...
	async ApplyMarketplaceMods(dir) {
		...
		const dest_dirr = path.join(os.homedir(), '.var/app/org.vinegarhq.Sober/data/sober/asset_overlay/');
		...
		console.warn("Restart Sober to apply the mods. If you not opened Sober, you can ignore this message.");
	}
}
